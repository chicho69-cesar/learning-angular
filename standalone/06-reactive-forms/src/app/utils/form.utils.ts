...
async function sleep(ms: number = 2500): Promise<boolean> {
...
export class FormUtils {
  ...
  public static isValidField(form: FormGroup, fieldName: string): boolean | null {
    return (
  ...
  public static isValidFieldInArray(formArray: FormArray, index: number) {
    return (
  ...
  public static async checkingServerResponse(control: AbstractControl): Promise<ValidationErrors | null> {
    await sleep();
  ...
  public static notStrider(control: AbstractControl): ValidationErrors | null {
