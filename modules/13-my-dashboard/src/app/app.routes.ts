...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./dashboard/pages/view-transitions/view-transitions-1/view-transitions-1.component'),
      },
      {
        path: 'view-transition-2',
        title: 'View Transition 2',
        loadComponent: () =>
          import('./dashboard/pages/view-transitions/view-transitions-2/view-transitions-2.component'),
      },
      {
        path: 'inputs-outputs',
